<div x-data="tipCreate()">
    <div class="category-panel tip-create">
        <div class="category-panel__content tip-create__content">
            <form class="tip-create__form" action="" method="POST">
                @csrf

                <div class="tip-create__sticky-bar">
                    <div class="tip-create__sticky-left">
                        <a class="category-panel__bulk-btn category-panel__bulk-btn--ghost tip-create__back" href="{{ route('admin', ['tab' => 'tips']) }}">← 목록</a>
                    ...
                    <div class="tip-create__sticky-actions">
                        ...
                        <button class="category-panel__bulk-btn category-panel__bulk-btn--accent" type="submit">게시하기</button>
                    </div>
                </div>
