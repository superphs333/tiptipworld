...
![TipTipWorld 사용자 Flow](docs/user-flow.svg)

TipTipWorld의 사용자 흐름은 공개 탐색, 로그인 후 상호작용과 개인 활동 관리, 관리자 운영 흐름으로 나뉨. 사용자는 홈에서 팁 목록, 검색, 카테고리, 태그, 사용자 피드를 통해 팁 상세로 이동하고, 로그인 후 좋아요, 북마크, 댓글, 팔로우, 글작성, 마이페이지 기능을 사용할 수 있음.
