...
| 시스템 구조 | 요청 흐름, 컨테이너 네트워크, Laravel 처리 계층, 주요 데이터 구조 | [docs/architecture.md](docs/architecture.md) |
| 서비스 | Docker Compose 서비스 목록, 포트, 볼륨, 서비스별 문서 링크 | [docs/services.md](docs/services.md) |
| 운영 | 관리 UI 접속, 상태 확인, 로그, 캐시/큐/마이그레이션 운영 명령 | [docs/operations.md](docs/operations.md) |
