...
이 프로젝트는 일상에서 검증한 작은 노하우를 체계적으로 모으고, 필요한 사람이 빠르게 찾아 다시 활용할 수 있게 만드는 것을 목적으로 합니다. 서비스를 체험하려는 사용자는 기능 목록과 설치 문서를 먼저 확인하고, 개발자는 애플리케이션 구조와 서버 구성 문서를 함께 보면 됩니다.
